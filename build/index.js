...
var _privileges = _interopRequireDefault(require("./routes/privileges"));

var _projects = _interopRequireDefault(require("./routes/projects"));

var _projectusers = _interopRequireDefault(require("./routes/projectusers"));
...
var _issues = _interopRequireDefault(require("./routes/issues"));

var _assets = _interopRequireDefault(require("./routes/assets"));

var _checklists = _interopRequireDefault(require("./routes/checklists"));

var _fpts = _interopRequireDefault(require("./routes/fpts"));

var _events = _interopRequireDefault(require("./routes/events"));

var _submittals = _interopRequireDefault(require("./routes/submittals"));

var _images = _interopRequireDefault(require("./routes/images"));

var _oprs = _interopRequireDefault(require("./routes/oprs"));

var _oprballots = _interopRequireDefault(require("./routes/oprballots"));

var _oprquestions = _interopRequireDefault(require("./routes/oprquestions"));

var _oprresponses = _interopRequireDefault(require("./routes/oprresponses"));
...
var subscriptionItems = new Map([[1, {
  priceInCents: 4900,
  name: "Basic"
}], [2, {
  priceInCents: 7900,
          ...
          case 0:
            ...
            return stripe.checkout.sessions.create({
              ...
              line_items: req.body.items.map(function (item) {
                var storeItem = subscriptionItems.get(item.id);
                return {
                  price_data: {
                    currency: 'usd',
                    product_data: {
              ...
              success_url: "".concat(process.env.SERVER_URL, "/success.html"),
              cancel_url: "".concat(process.env.SERVER_URL, "/cancel.html")
            });
...
app.use('/privileges', _privileges["default"]);
app.use('/projects', _projects["default"]);
app.use('/projectusers', _projectusers["default"]);
...
app.use('/issues', _issues["default"]);
app.use('/assets', _assets["default"]);
app.use('/checklists', _checklists["default"]);
app.use('/fpts', _fpts["default"]);
app.use('/events', _events["default"]);
app.use('/submittals', _submittals["default"]);
app.use('/oprs', _oprs["default"]);
app.use('/oprballots', _oprballots["default"]);
app.use('/oprquestions', _oprquestions["default"]);
app.use('/oprresponses', _oprresponses["default"]);
