...
module.exports = function (sequelize, DataTypes) {
  var Checklistquestion = /*#__PURE__*/function (_Model) {
    _inherits(Checklistquestion, _Model);

    var _super = _createSuper(Checklistquestion);

    function Checklistquestion() {
      _classCallCheck(this, Checklistquestion);

      return _super.apply(this, arguments);
    }

    _createClass(Checklistquestion, null, [{
      key: "associate",
      value:
      /**
