...
module.exports = function (sequelize, DataTypes) {
  var Oprresponse = /*#__PURE__*/function (_Model) {
    _inherits(Oprresponse, _Model);

    var _super = _createSuper(Oprresponse);

    function Oprresponse() {
      _classCallCheck(this, Oprresponse);

      return _super.apply(this, arguments);
    }

    _createClass(Oprresponse, null, [{
      key: "associate",
      value:
      /**
