...
module.exports = function (sequelize, DataTypes) {
  var Oprquestion = /*#__PURE__*/function (_Model) {
    _inherits(Oprquestion, _Model);

    var _super = _createSuper(Oprquestion);

    function Oprquestion() {
      _classCallCheck(this, Oprquestion);

      return _super.apply(this, arguments);
    }

    _createClass(Oprquestion, null, [{
      key: "associate",
      value:
      /**
